...
!Deprecated DP_particle_analysis -  в этом файле происходит считывание информации с файлов с данными (не включены), и моделирование распределения на детекторах, основываясь на введенных в первом блоке параметрах.
...
ExtractFeatures - файл, в котором реализованы алгоритмы моделирования детекторов и построения признаков события
